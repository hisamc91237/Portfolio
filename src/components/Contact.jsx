    ...
    <>
      <SectionWrapper id="contact" className="scroll-mt-20">
        <div className="p-4 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <a href="mailto:rhythmdoshi04@gmail.com" className="px-6 py-3 bg-zinc-900 dark:bg-zinc-50 text-zinc-50 dark:text-zinc-900 font-medium rounded-full hover:scale-105 transition-transform active:scale-95 text-sm">
            Say Hello
          </a>
        </div>
      </SectionWrapper>
