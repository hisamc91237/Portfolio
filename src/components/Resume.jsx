...
import { Download, ArrowLeft, Eye, ZoomIn, ZoomOut, Maximize } from 'lucide-react';
          ...
          <div className="pt-6 pb-6 px-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                {/* Zoom Controls */}
                <div className="hidden sm:flex items-center gap-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-full p-1 mr-2 shadow-sm">
                  <button 
                  ...
                  <span className="text-xs font-mono w-12 text-center text-zinc-500">{Math.round(scale * 100)}%</span>
                  <button 
                ...
                <a 
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-50 border border-zinc-200 dark:border-zinc-800 rounded-full font-bold text-sm hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all active:scale-95 shadow-sm"
                >
                ...
                <a 
                  href="/resume.pdf" 
                  download
                  className="flex items-center gap-2 px-6 py-3 bg-zinc-900 dark:bg-zinc-100 text-zinc-100 dark:text-zinc-900 rounded-full font-bold text-sm hover:scale-105 transition-transform active:scale-95 shadow-xl shadow-zinc-200 dark:shadow-zinc-900"
                >
